...
<body>
    ...
    <div class="cp-container">
        ...
        <div id="dashboard" class="tab-content active">
            <div class="stats-grid">
                ...
                <div class="stat-card">
                    <div class="stat-number" id="settingsCount">1</div>
        ...
        <div id="media" class="tab-content">
            <div class="content-card">
                ...
                <form id="mediaForm" class="form-grid" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-input" name="date" value="<?php echo date('Y-m-d'); ?>">
                    </div>
            ...
            <div class="content-card">
                ...
                <div class="content-list" id="mediaList">
                    <p style="text-align: center; color: var(--text-light);">Loading media items...</p>
                </div>
            </div>
        </div>
                ...
                <form id="articleForm" class="form-grid">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-input" name="pub_date" value="<?php echo date('Y-m-d'); ?>">
                        </div>
                    </div>
        ...
        <div id="projects" class="tab-content">
            ...
            <div class="content-card">
                ...
                <div class="content-list" id="projectsList">
                    <p style="text-align: center; color: var(--text-light);">Loading projects...</p>
                </div>
            </div>
        </div>
        ...
        <div id="debug" class="tab-content">
            <div class="content-card">
                ...
                <div class="debug-info" id="debugInfo">
                    <p><strong>API Base:</strong> <span id="apiBase">./api/endpoints.php</span></p>
                ...
                <div class="btn-group">
                    ...
                    <button class="btn btn-secondary" onclick="checkPermissions()">📁 Check Permissions</button>
                </div>
                
                <div id="debugResults" class="debug-info" style="margin-top: 1rem; display: none;">
                    <h4>Test Results:</h4>
    ...
    <script>
        ...
        function loadMediaList() {
            makeRequest('get_media')
                    ...
                    mediaList.innerHTML = data.map(item => `
                        <div class="content-item">
                            <div class="content-info">
                                ...
                                <div class="content-meta">Added: ${item.created_at}</div>
                            </div>
                ...
                .catch(error => {
                    ...
                    showNotification('Failed to load media list: ' + error.message, 'error');
                    document.getElementById('mediaList').innerHTML = '<p style="color: red;">Failed to load media items.</p>';
                });
        }
        ...
        function loadArticlesList() {
            makeRequest('get_articles')
                ...
                .catch(error => {
                    ...
                    showNotification('Failed to load articles: ' + error.message, 'error');
                });
        }
            ...
            makeRequest('get_stats')
                .then(data => {
                    debugOutput.innerHTML = `
                        ...
                        <p>Stats loaded: ${JSON.stringify(data)}</p>
                    `;
                })
                .catch(error => {
                    debugOutput.innerHTML = `
        ...
        function checkPermissions() {
            const debugOutput = document.getElementById('debugOutput');
            debugOutput.innerHTML = 'Checking permissions...';
            
            // This is a basic check - in a real scenario you'd have a PHP endpoint to check this
            debugOutput.innerHTML = `
                <p>Permission check would require server-side verification.</p>
                <p>Check that these directories exist and are writable:</p>
                <ul>
                    <li>./api/data/</li>
                    <li>./uploads/</li>
                </ul>
        ...
        document.getElementById('mediaForm').addEventListener('submit', function(e) {
            ...
            makeRequest('add_media', 'POST', formData)
                ...
                .catch(error => {
                    hideLoading();
                    showNotification('Failed to add media: ' + error.message, 'error');
                });
        });
